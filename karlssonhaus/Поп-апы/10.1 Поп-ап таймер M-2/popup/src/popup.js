var cqpopup_name = '10.1 Поп-ап таймер M-2';
var carrotquest = {
    ...
    resizeFrame: function(maxWidth, height, margin) {
        var data = { command: 'carrotquest.resizeFrame', 'id': '{{ sending_id }}', 'maxWidth': maxWidth, 'height': height,'margin':margin};
        top.postMessage(data, '*');
    }
};
