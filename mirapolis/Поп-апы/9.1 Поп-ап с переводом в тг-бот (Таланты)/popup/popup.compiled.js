...
\
            <p class="cq-popup__text-h1">Ваш персональный <br class="mob">HR-помощник в Telegram</p>\
            <p class="cq-popup__text">Который поможет вам:</p>\
            <div class="line">\
                <img src="https://files.carrotquest.app/message-images/68184/68184-1756196143952-cjrpjzuc.png" alt=""\
                     class="line_img">\
                <p class="line_text"><span>Мгновенно получить</span> наши полезные гайды <br class="pc">или чек-лист прямо в чате</p>\
            </div>\
            <div class="line">\
                <img src="https://files.carrotquest.app/message-images/68184/68184-1756196143952-cjrpjzuc.png" alt=""\
                     class="line_img">\
                <p class="line_text"><span>Первыми узнавать</span> о новых вебинарах и статьях, <br class="pc">чтобы вы не упустили\
                    важное</p>\
            </div>\
            <div class="line">\
                <img src="https://files.carrotquest.app/message-images/68184/68184-1756196143952-cjrpjzuc.png" alt=""\
                     class="line_img">\
                <p class="line_text"><span>Подобрать решение</span> с экспертом, задав всего пару <br class="pc">вопросов о ваших\
                    HR-задачах</p>\
            </div>\
            <a href="#" target="_blank" class="link">Перейти в Telegram</a>\
        </form>\
        <img src="https://files.carrotquest.app/message-images/68184/68184-1756196202338-wpfqcv8s.png" alt=""\
             class="pc">\
        <img src="https://files.carrotquest.app/message-images/68184/68184-1756196219062-9knrx65d.png" alt=""\
             class="mob">\
    </div>\
</div>\
<script>"use strict";\
...
var cqpopup_name = "9.1 Поп-ап с переводом в тг-бот (Таланты)",\
  carrotquest = {\
