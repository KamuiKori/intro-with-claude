...
<div class="wrapper__body d_flex">\
    <div class="cq-popup__body d_flex flex_col">\
        ...
        <form id="form" class="cq-popup__form d_flex flex_col first-form">\
            <p class="cq-popup__text-h1">Не уходите без подарка — книга <br class="pc">с ключевыми HR-метриками!</p>\
        ...
        <form action="" id="phone_form" class="cq-popup__form d_flex flex_col hidden">\
            ...
            <div class="inputs">\
                <input type="email" name="email" placeholder="E-mail" class="cq_input" required id="email">\
        ...
        <img src="https://files.carrotquest.app/message-images/68184/68184-1756190212491-82gewv5h.png" alt=""\
             class="pc">\
        <img src="https://files.carrotquest.app/message-images/68184/68184-1756190227325-g1mocr4q.png" alt=""\
             class="mob">\
    </div>\
</div>\
<script>"use strict";\
...
var cqpopup_name = "5.1А Поп-ап на попытку ухода (Мираполис)",\
  carrotquest = {\
