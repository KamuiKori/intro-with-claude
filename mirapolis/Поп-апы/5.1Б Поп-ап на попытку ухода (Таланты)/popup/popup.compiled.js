...
<div class="wrapper__body d_flex">\
    <div class="cq-popup__body d_flex flex_col">\
        ...
        <form action="" id="phone_form" class="cq-popup__form d_flex flex_col ">\
            ...
            <input type="tel" name="phone" placeholder="*Ваш телефон" class="cq_input" required id="phone">\
        ...
        <img src="https://files.carrotquest.app/message-images/68184/68184-1756108434695-45ca5uar.png" alt=""\
             class="pc">\
        <img src="https://files.carrotquest.app/message-images/68184/68184-1756109750589-binylotj.png" alt=""\
             class="mob">\
    </div>\
</div>\
<script>"use strict";\
...
var cqpopup_name = "5.1Б Поп-ап на попытку ухода (Таланты)",\
  carrotquest = {\
